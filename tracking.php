...
$dbpass= "";
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql= "SELECT `file_no` FROM `file_details` WHERE `file_no`= '$file_no'";
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark pt-3 pb-3">
    ...
    <div class="container-fluid">
      ...
      <form class="d-flex" form action="tracking.php" method="POST">
...
<?php
        if($invalid_name){
            ...
            <strong>You may have entered wrong file name. PLease try again</strong> .
...
<br><center><h1>Director</h1></center><hr> <br>
    <form action="/fts-nitttr-kolkata/tracking.php" method="POST">
      
    <div class="form-group row">
        <label for="colFormLabelLg" class="col-sm-2 col-form-label col-form-label-lg" style="width: 9.666667%;">Name of the</label>
        <div class="col-sm-5">
        <input type="text" class="form-control form-control-lg" style="width: 100%;" name="file_no" id="colFormLabelLg" placeholder="" autofocus="">
        </div>
    
    <div class="col-sm-5">
              <input type ="submit" class="btn btn-primary btn-lg" style="margin-left: 50px;" name="submit" value="Enter"/>
          </div>
          </div>
    </form>
    <br>
